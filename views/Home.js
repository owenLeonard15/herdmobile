...
const HomeScreen = ({navigation}) => {
    ...
    const [restaurantState, setRestaurantState] = useState(new Map());
    ...
    useEffect(() => {
        const init = async() => {
            ...
            for (var i = 0; i < favResList.length; i++){
                favResSet.add(favResList[i].resName);
            }
